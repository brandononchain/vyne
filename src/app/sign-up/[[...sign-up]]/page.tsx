    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9f4]">
      <div className="w-full max-w-[440px] px-4">
        <div className="text-center mb-6">
          ...
          <h1 className="text-[22px] font-bold text-[#1a2316] mb-1">Create your Vyne account</h1>
          <p className="text-[13px] text-[#4d5a45]">Start building AI agent workflows in minutes</p>
        </div>
        <SignUp
          appearance={{
            elements: {
